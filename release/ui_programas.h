/********************************************************************************
** Form generated from reading UI file 'programas.ui'
**
...
#ifndef UI_PROGRAMAS_H
#define UI_PROGRAMAS_H
...
public:
    ...
    void setupUi(QWidget *programa)
    {
        ...
        programa->resize(821, 346);
        verticalLayout = new QVBoxLayout(programa);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        label = new QLabel(programa);
...
"color: rgb(00,56,147);"));
        ...
        tabla = new QTableWidget(programa);
    ...
    {
        programa->setWindowTitle(QApplication::translate("programa", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("programa", "Programas", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = tabla->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("programa", "ID", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = tabla->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("programa", "Abrev", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = tabla->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("programa", "Descripcion", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = tabla->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("programa", "Telefonos", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = tabla->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("programa", "Director", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = tabla->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("programa", "Direccion", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = tabla->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("programa", "Email", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
